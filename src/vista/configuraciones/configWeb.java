...
public class configWeb extends JDialog implements ActionListener {
    ...
    private String[] columnNames = {"Nombre de la App", "URL", "Usuario", "Correo", "Contrasena"};
    private Object[][] data ={
            {"","","","","","",""},
            {"","","","","","",""},
            {"","","","","","",""},
    ...
    public configWeb(Frame owner, String title, boolean modal){
